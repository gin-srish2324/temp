...
```
{
        "ok" : 1,
        "$clusterTime" : {
                "clusterTime" : Timestamp(1681425677, 1),
                "signature" : {
                        "hash" : BinData(0,"AAAAAAAAAAAAAAAAAAAAAAAAAAA="),
                        "keyId" : NumberLong(0)
                }
        },
        "operationTime" : Timestamp(1681425677, 1)
}
```
...
{
        "acknowledged" : true,
        "insertedId" : ObjectId("6438861a61ddb3e87c32e464")
}
```
...
```
{
        "acknowledged" : true,
        "insertedIds" : [
                ObjectId("6438862861ddb3e87c32e465"),
                ObjectId("6438862861ddb3e87c32e466"),
                ObjectId("6438862861ddb3e87c32e467"),
                ObjectId("6438862861ddb3e87c32e468")
        ]
}
```
...
```
{
        "_id" : ObjectId("6438861a61ddb3e87c32e464"),
        "name" : "John Doe",
        "major" : "Computer Science",
        "GPA" : 3.5,
        "enrolled_courses" : [
...
{
        "_id" : ObjectId("6438862861ddb3e87c32e465"),
        "name" : "Jane Smith",
        "major" : "Mathematics",
        "GPA" : 3.9,
        "enrolled_courses" : [
...
{
        "_id" : ObjectId("6438862861ddb3e87c32e466"),
        "name" : "Bob Johnson",
        "major" : "English",
        "GPA" : 3.2,
        "enrolled_courses" : [
...
{
        "_id" : ObjectId("6438862861ddb3e87c32e467"),
        "name" : "Samantha Lee",
        "major" : "Biology",
        "GPA" : 3.8,
        "enrolled_courses" : [
...
{
        "_id" : ObjectId("6438862861ddb3e87c32e468"),
        "name" : "David Kim",
        "major" : "Economics",
        "GPA" : 3.4,
        "enrolled_courses" : [
...
```javascript
db.students.find(
    {"major":"Computer Science", "enrolled_courses.course_name" : "Web Development" }
)
...
```javascript
 db.students.updateOne({"email": "jdoe@illinois.edu"}, {$unset: {"enrolled_courses": ""}})
...
```javascript
db.students.find({     "name": {"$regex": "doe", $options: "i"} }).pretty()
...
db.students.find({"GPA" :{ $gte: 3.5, $lte: 3.9}}).pretty()
```
Output
```
{
...
```
{
        "ok" : 1,
        "$clusterTime" : {
                "clusterTime" : Timestamp(1681425541, 1),
                "signature" : {
                        "hash" : BinData(0,"AAAAAAAAAAAAAAAAAAAAAAAAAAA="),
                        "keyId" : NumberLong(0)
                }
        },
        "operationTime" : Timestamp(1681425541, 1)
}
```
